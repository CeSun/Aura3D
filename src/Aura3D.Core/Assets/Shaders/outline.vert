...
void main()
{
	...
	// vec3 positionOS = position + outlineWidth  * 0.00001 * normal;
	...
	normalPrj = normalize(normalPrj);
	normalPrj.z = 0.5;

	vec4 ret = projectionMatrix * viewMatrix * worldPosition;
	ret.xyz += normalPrj.xyz * outlineWidth * 0.001 * ret.w;
