...
public static class PBRMaterialExtensions
{
...
#endif
    public static Texture? GetMetallicRoughness(this Material material) => material.GetTexture("MetallicRoughness");
    ...
    [Obsolete("Use the MetallicRoughness extension property instead.", false)]
#endif
    public static void SetMetallicRoughness(this Material material, Texture? texture) => material.SetTexture("MetallicRoughness", texture);
...
#endif
    public static Texture? GetOcclusion(this Material material) => material.GetTexture("Occlusion");
    ...
    [Obsolete("Use the Occlusion extension property instead.", false)]
#endif
    public static void SetOcclusion(this Material material, Texture? texture) => material.SetTexture("Occlusion", texture);
...
#endif
    public static Texture? GetEmissive(this Material material) => material.GetTexture("Emissive");
    ...
    [Obsolete("Use the Emissive extension property instead.", false)]
#endif
    public static void SetEmissive(this Material material, Texture? texture) => material.SetTexture("Emissive", texture);
}
